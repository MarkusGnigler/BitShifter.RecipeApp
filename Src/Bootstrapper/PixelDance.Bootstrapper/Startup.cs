...
using PixelDance.Modules.Recipes.Api;
using PixelDance.Modules.Identity.Api;
using PixelDance.Shared.Abstractions;
using PixelDance.Shared.Infrastructure;
using PixelDance.Shared.Infrastructure.Bootstrapper;
using PixelDance.Shared.Infrastructure.Bootstrapper.Filters;
...
namespace PixelDance.Bootstrapper
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddPxdCors(_configuration);
