...
import { IdentityService } from '@bitshifter-webui/identity-lib';
import { NavItem } from '@bitshifter-webui/ui-lib';
import { environment } from '../environments/environment';

@Component({
	selector: 'bs-app-layout',
	template: `
		<!-- SIDENAV-HEADER -->
		...
		<ng-template #navFooterTemplate>
			<a class="footer-link" href="https://www.bit-shifter.at">bitshifter &copy; {{ currentYear }}</a>
		</ng-template>
